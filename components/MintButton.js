...
export default function MintButton() {
    ...
    const jesiArtContract = new Contract(JESI_ART_CONTRACT_ADDRESS, jesiArtInterface)

    const { send: mintSend, state: mintState } = useContractFunction(jesiArtContract, "create_ntf",
        { transactionName: "Mint NFT" })

    const jsonURI = "https://ipfs.io/ipfs/Qmd9MCGtdVz2miNumBHDbvj8bigSgTwnr4SbyH6DNnpWdt?filename=0-PUG.json" // TODO remove and upload own json
    const mint = () => {
